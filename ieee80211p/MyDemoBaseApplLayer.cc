...
void MyDemoBaseApplLayer::initialize(int stage)
{
    MyBaseApplLayer::initialize(stage);
...
simtime_t MyDemoBaseApplLayer::computeAsynchronousSendingTime(simtime_t interval, ChannelType chan)
{
...
void MyDemoBaseApplLayer::populateWSM(BaseFrame1609_4* wsm, LAddress::L2Type rcvId, int serial)
{
...
void MyDemoBaseApplLayer::receiveSignal(cComponent* source, simsignal_t signalID, cObject* obj, cObject* details)
{
    Enter_Method_Silent();
...
void MyDemoBaseApplLayer::handlePositionUpdate(cObject* obj)
{
...
void MyDemoBaseApplLayer::handleParkingUpdate(cObject* obj)
{
    isParked = mobility->getParkingState();
}

void MyDemoBaseApplLayer::handleLowerMsg(cMessage* msg)
{
...
void MyDemoBaseApplLayer::handleSelfMsg(cMessage* msg)
{
    switch (msg->getKind()) {
    case SEND_BEACON_EVT: {
        ...
        //추가    beacon 수정..
        bsm->setSenderMacAddr(this->mac->getMACAddress());
...
void MyDemoBaseApplLayer::finish()
{
...
MyDemoBaseApplLayer::~MyDemoBaseApplLayer()
{
...
void MyDemoBaseApplLayer::startService(Channel channel, int serviceId, std::string serviceDescription)
{
...
void MyDemoBaseApplLayer::stopService()
{
    cancelEvent(sendWSAEvt);
    currentOfferedServiceId = -1;
}

void MyDemoBaseApplLayer::sendDown(cMessage* msg)
{
    checkAndTrackPacket(msg);
    MyBaseApplLayer::sendDown(msg);
}

void MyDemoBaseApplLayer::sendDelayedDown(cMessage* msg, simtime_t delay)
{
    checkAndTrackPacket(msg);
    MyBaseApplLayer::sendDelayedDown(msg, delay);
}

void MyDemoBaseApplLayer::checkAndTrackPacket(cMessage* msg)
{
