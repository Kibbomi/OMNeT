/*
 * VehicleBaseAppLayer.h
 *
 *  Created on: 2021. 5. 1.
 *      Author: bum71
 */

#ifndef SRC_VEINS_MODULES_APPLICATION_IEEE80211P_VEHICLEBASEAPPLAYER_H_
#define SRC_VEINS_MODULES_APPLICATION_IEEE80211P_VEHICLEBASEAPPLAYER_H_
 ...
 * @see Decider80211p
 */
class VEINS_API VehicleBaseAppLayer : public BaseApplLayer {

public:
    ~VehicleBaseAppLayer() override;
...
protected:
    ...
    virtual void onBSM(RSUBeacon* bsm){};
...
#endif /* SRC_VEINS_MODULES_APPLICATION_IEEE80211P_VEHICLEBASEAPPLAYER_H_ */
