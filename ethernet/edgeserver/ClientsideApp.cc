...
void ClientsideApp::initialize(int stage)
{
...
void ClientsideApp::handleMessageWhenUp(cMessage *msg)
{
...
void ClientsideApp::handleStartOperation(LifecycleOperation *operation)
{
...
void ClientsideApp::handleStopOperation(LifecycleOperation *operation)
{
...
void ClientsideApp::handleCrashOperation(LifecycleOperation *operation)
{
...
void ClientsideApp::socketClosed(inet::Ieee8022LlcSocket *socket)
{
...
bool ClientsideApp::isGenerator()
{
    EV<<" Client : Call isGenerator."<<std::endl;
    return par("destAddress").stringValue()[0];
}

void ClientsideApp::scheduleNextPacket(bool start)
{
...
void ClientsideApp::cancelNextPacket()
{
...
MacAddress ClientsideApp::resolveDestMacAddress()
{
...
void ClientsideApp::socketDataArrived(Ieee8022LlcSocket*, Packet *msg)
{
