...
#ifndef __INET_MYETHERAPPCLIENT_H
#define __INET_MYETHERAPPCLIENT_H
 ...
 */
class INET_API MyEtherAppClient : public ApplicationBase, public Ieee8022LlcSocket::ICallback
{
  protected:
  ...
  protected:
    ...
    virtual void scheduleNextPacket(bool start);    //이것도 매개변수 넘겨줘야 할 것같은데.cMessage로
  ...
  public:
    MyEtherAppClient() {}
    virtual ~MyEtherAppClient();
};

} // namespace inet

#endif // ifndef __INET_MYETHERAPPCLIENT_H
