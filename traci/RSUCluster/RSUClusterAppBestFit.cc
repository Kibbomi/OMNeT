...
#include "veins/modules/application/traci/RSUCluster/RSUClusterAppBestFit.h"
...
Define_Module(RSUClusterAppBestFit);

//추가
void RSUClusterAppBestFit::initialize(int stage)
{
...
void RSUClusterAppBestFit::finish()
{
...
void RSUClusterAppBestFit::onWSA(DemoServiceAdvertisment* wsa)
{
...
void RSUClusterAppBestFit::onWSM(BaseFrame1609_4* frame)
{
...
//HandleMessage
void RSUClusterAppBestFit::handleMessage(cMessage* msg)
{
...
//override함.
void RSUClusterAppBestFit::handleSelfMsg(cMessage* msg)
{
...
void RSUClusterAppBestFit::socketDataArrived(inet::Ieee8022LlcSocket *socket, inet::Packet *msg)
{
        ...
        ++RSUClusterMessages;
            ...
            if(resp->isAvailable())
            {
                ...
                if(!q.empty()){
                    ...
                    FindOptimalES(q.front().getRequiredCycle(), q.front().getConstraint());   //Queue로 옮기기
                    outPayload->setChunkLength(inet::units::values::B(88));
...
void RSUClusterAppBestFit::socketClosed(inet::Ieee8022LlcSocket *socket)
{
...
//implementation EPS
void RSUClusterAppBestFit::BeginERS(int init, int threshold){
...
void RSUClusterAppBestFit::FindOptimalES(double requiredCycle, simtime_t constraint){
...
void RSUClusterAppBestFit::FindOptimalES(){
    EV<<this->getParentModule()->getFullName()<<" call FindOptimalES\n";
    //myOptimal 갱신이 필요한 것.
    inet::Format_EdgeServer OptimalES;
...
void RSUClusterAppBestFit::SendRSUCOLevel(bool level)
{
    return ;
