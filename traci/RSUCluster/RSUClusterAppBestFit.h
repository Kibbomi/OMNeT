 ...
 */
constexpr int INITVAL = 987654321;
constexpr double propagationDelay = 0.02;   //20ms
class VEINS_API RSUClusterAppBestFit : public MyDemoBaseApplLayer, public inet::Ieee8022LlcSocket::ICallback {
//public 추가
public:
    ...
    //for get Optimal RSU..
    void FindOptimalES();
    void FindOptimalES(double Cycle, simtime_t constraint);
