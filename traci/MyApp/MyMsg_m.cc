...
MyMsg::MyMsg(const char *name, short kind) : ::veins::BaseFrame1609_4(name,kind)
{
    this->hello = false;
}

MyMsg::MyMsg(const MyMsg& other) : ::veins::BaseFrame1609_4(other)
{
    copy(other);
}
...
bool MyMsg::getHello() const
{
    return this->hello;
}

void MyMsg::setHello(bool hello)
{
    this->hello = hello;
}
...
MyMsgDescriptor::MyMsgDescriptor() : omnetpp::cClassDescriptor("veins::MyMsg", "veins::BaseFrame1609_4")
{
...
int MyMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='h' && strcmp(fieldName, "hello")==0) return base+0;
...
std::string MyMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    MyMsg *pp = (MyMsg *)object; (void)pp;
    switch (field) {
        case 0: return bool2string(pp->getHello());
        default: return "";
    }
}
...
bool MyMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    MyMsg *pp = (MyMsg *)object; (void)pp;
    switch (field) {
        case 0: pp->setHello(string2bool(value)); return true;
