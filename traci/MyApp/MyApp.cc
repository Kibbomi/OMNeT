...
void MyApp::onWSM(BaseFrame1609_4* wsm)
{
    ...
    EV << "Car : Offloading Result is : " << msg->getRet()<<std::endl;
}
...
void MyApp::handleSelfMsg(cMessage* msg)
{
    ...
    if(msg->getKind() == (short)Msg_MsgOffloading ){   //getkind말고 int값으로 정의하는게 더 좋을 듯.
        ...
        pac_schedule ->setName("Offloading_MSG");
