...
LAddress::L2Type& DemoSafetyMessage::getSenderMacAddr()
{
    return this->senderMacAddr;
}

void DemoSafetyMessage::setSenderMacAddr(const LAddress::L2Type& senderMacAddr)
{
...
int DemoSafetyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "senderMacAddr")==0) return base+2;
...
std::string DemoSafetyMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: {std::stringstream out; out << pp->getSenderMacAddr(); return out.str();}
        default: return "";
    }
}
...
void *DemoSafetyMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return (void *)(&pp->getSenderMacAddr()); break;
        default: return nullptr;
    }
}
